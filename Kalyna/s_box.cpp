...
const unsigned char s_box[4][256] = { {
...
const unsigned char s_box_inv[4][256] = { {
...
//#ifndef m
//#define m 17
//	unsigned __int8 M_s_box[10][17] = {
//		{0x10,0x11,0x12,0x13,0x14,0x15,0x16,0x17,0x18,0x19,0x1A,0x1B,0x1C,0x1D,0x1E,0x1F},
//		{0xF0,0x48,0x85,0x9F,0x05,0x79,0x8D,0x3E,0xD1,0xA3,0x56,0xAE,0x29,0x48,0x89,0xB4},
//		{0x4C,0x81,0xF5,0xA9,0x4C,0x9B,0x65,0xBF,0xB1,0xE7,0xB3,0x9F,0xF3,0x2F,0x0E,0xCF},
//		{0x72,0xC4,0xCD,0x85,0x08,0x95,0xD6,0x3F,0x51,0x8C,0x31,0x10,0x19,0x93,0x0C,0xC3},
//		{0x36,0x22,0x86,0xD8,0xB7,0x2B,0xB9,0x82,0x44,0x36,0x57,0xA6,0x59,0xF5,0xDB,0xEB},
//		{0xA8,0xF5,0x85,0x98,0x15,0x6A,0x3F,0xD4,0x8E,0x4F,0x76,0xB8,0xBB,0x22,0x6D,0xFC},
//		{0x12,0xAB,0x0C,0xE9,0x67,0x77,0x8B,0x45,0x7C,0x73,0x00,0x1A,0x11,0x62,0x75,0xFE},
//		{0x26,0xE8,0x50,0x33,0x6E,0x6D,0x4F,0xC2,0x3E,0x57,0x1E,0xF6,0x95,0x69,0x8E,0x11},
//		{0x1A,0xEB,0x8E,0x54,0xB0,0x24,0x3F,0x89,0x16,0x30,0xE4,0x55,0xA4,0x86,0x7B,0x44},
//		{0x8F,0xF7,0x4B,0xB6,0xA0,0x8A,0xE3,0x9B,0xC5,0xD3,0x5C,0x03,0x07,0x7E,0x32,0x16} };
//	unsigned __int8 C_s_box[10][17] = {
//		{0x9A,0x2B,0x1E,0xAC,0x76,0xEE,0x89,0x1B,0x91,0x4A,0xCF,0x17,0x7C,0x98,0xDD,0x3D},
//		{0x81,0xD1,0x3F,0xB2,0x75,0x62,0xED,0xE1,0xEA,0x4B,0x55,0x42,0xBF,0xD1,0xF7,0x6F},
//		{0x8F,0xDA,0x86,0x33,0x8F,0x6A,0x9C,0x7A,0xBE,0xA6,0x3A,0xB2,0xED,0x4D,0x51,0x39},
//		{0x24,0x9A,0x64,0x8F,0x71,0x47,0x75,0xDF,0xE7,0x0E,0x2C,0x22,0xE0,0xFE,0x9F,0x0F},
//		{0xFA,0x64,0x88,0x81,0x31,0xB1,0xFA,0x10,0x42,0x44,0xC6,0x07,0x65,0xED,0x68,0xAD},
//		{0xC5,0xED,0x3F,0xA4,0x4D,0x79,0x90,0xFE,0x89,0xEE,0x6C,0xDA,0x99,0x64,0x7C,0x57},
//		{0x1D,0xC3,0x9F,0x95,0x53,0x97,0xE9,0xF4,0x14,0x6C,0x93,0xB7,0xF3,0x48,0x6E,0xE0},
//		{0x9A,0xEC,0x10,0x45,0xC3,0x8C,0x35,0x93,0xBB,0xA1,0x16,0x4C,0xD7,0x0D,0x80,0x03},
//		{0x97,0x03,0x80,0xC8,0xB3,0x9E,0x90,0x9A,0x2C,0x7C,0xF1,0x48,0x00,0x55,0xE5,0xE5},
//		{0xFF,0x66,0x12,0x01,0x78,0x9C,0x58,0x1D,0x03,0x74,0xD3,0x4D,0x59,0x83,0xC4,0x53} };
//
//	uint8_t *c, *d;
//	c = new uint8_t[m];
//	d = new uint8_t[m];
//	for (int i = 0; i < n; i++) {
//		//msg = hex2char(testSrc[i]);
//		cout << left << setw(10) << setfill(' ') << "m: "; printuc(M_s_box[i]);
//		c = SubBytes(M_s_box[i], s_box);
//		cout << left << setw(10) << setfill(' ') << "c: "; printuc(c);
//		cout << left << setw(10) << setfill(' ') << "c: "; printuc(C_s_box[i]);
//		d = SubBytes(c, s_box_inv);
//		cout << left << setw(10) << setfill(' ') << "inv_c: "; printuc(d);
//		cout << endl;
//	}
//#endif
//#endif
